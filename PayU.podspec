#
#  Be sure to run `pod spec lint PayU.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "PayU"
  s.version      = "1.6.4"
  s.summary      = "PayTouch SDK for IOS."
...
The main use case is to accept single payment with following payment methods:
  ...
  s.authors            = { "Maciej Jastrzebski" => "mjastrzebski@objectivity.co.uk", "Łukasz Kuczyński" => "" }
  ...
  s.source       = { :git => "https://github.com/PayU/paytouch-ios.git", :tag => "#{s.version}" }
  ...
  s.resources  = "SDK/PayUOneClickSDK.bundle"
  # s.resources = "Resources/*.png"

  s.preserve_paths = "SDK/**/*",

  s.vendored_libraries = "SDK/libPayU-iOS-SDK-Oneclick_Release.a"
